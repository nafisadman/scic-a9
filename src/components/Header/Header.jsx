    ...
    <header className="bg-gray-900">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Link href="/products" className="text-sm/6 font-semibold text-white">
            Products
          </Link>
          <Link href="/dashboard/add-product" className="text-sm/6 font-semibold text-white">
            Add Product
          </Link>
        </PopoverGroup>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-white/10">
              <div className="space-y-2 py-6">
                <Link href="/products" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">
                  Products
                </Link>
                <Link href="/add-product" className="text-sm/6 font-semibold text-white">
                  Add Product
                </Link>
              </div>
              <div className="py-6">
